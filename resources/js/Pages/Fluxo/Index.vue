    ...
    <app-layout>
        ...
        >
            <div class="container">
                    ...
                    <div class="px-0 my-3 rounded-xl flex flex-col">
                        <div class="w-full">
                            ...
                            <a
                                ...
                                :href="
                                    route('fluxos.export', { term: this.term })
                                "
                                download="file.xlsx"
                            >
                                Exportar
                        ...
                        >
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    as="button"
                                    type="button"
                                    :href="route('fluxos.show', fluxo.id)"
                                >
                                ...
                                <Link
                                    ...
                                    as="button"
                                    type="button"
                                    :href="route('fluxos.edit', fluxo.id)"
                                >
                                    <span class="rounded-full text-white shadow-lg">
                ...
                <pagination class="mt-6" :links="fluxos.links" />
            </div>
        </div>
    </app-layout>
</template>
    ...
    methods: {
        destroy(fluxo) {
            if (confirm("Você tem certeza que deseja excluir este registro?")) {
                this.$inertia.delete(this.route("fluxos.destroy", fluxo.id));
            }
        },
        search() {
            this.$inertia.replace(
                this.route("fluxos.index", { term: this.term })
            );
        },
    },
};
