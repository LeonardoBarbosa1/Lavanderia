    ...
    <app-layout>
        ...
        >
            <div class="container">
                    ...
                    <div class="px-0 my-3 rounded-xl flex flex-col">
                        <div class="w-full">
                            ...
                            <a
                                ...
                                :href="
                                    route('cidades.export', { term: this.term })
                                "
                                download="file.xlsx"
                            >
                                Exportar
                ...
                <pagination class="mt-6" :links="cidades.links" />
            </div>
        </div>
    </app-layout>
</template>
    ...
    methods: {
        destroy(cidade) {
            if (confirm("Você tem certeza que deseja excluir este registro?")) {
                this.$inertia.delete(this.route("cidades.destroy", cidade.id));
            }
        },
        search() {
            this.$inertia.replace(
                this.route("cidades.index", { term: this.term })
            );
        },
    },
};
