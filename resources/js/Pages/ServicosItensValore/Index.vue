            ...
            <div class="container">
                <div class="mb-2 mt-6 flex justify-between items-center block">
                    <div class="px-0 my-3 rounded-xl flex flex-col">
                        <div class="w-full">
                            <Link
                                :href="route('servicos-itens-valores.create')"
                            ...
                            <a
                                ...
                                :href="
                                    route('servicos-itens-valores.export', {
                                        term: this.term,
                                    })
                                "
                                download="file.xlsx"
                ...
                <table class="min-w-full border-collapse block md:table">
                    ...
                    <tbody class="block md:table-row-group">
                        <tr
                            v-for="servicosItensValore in servicosItensValores.data"
                            :key="servicosItensValore.id"
                        ...
                        >
                            ...
                            >
                                <span
                                    class="inline-block w-1/3 md:hidden font-bold"
                                    >Produto Utilizado</span
                                >{{ servicosItensValore.produto_utilizado }}
                            </td>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    :href="
                                        route(
                                            'servicos-itens-valores.show',
                                            servicosItensValore.id
                                        )
                                    "
                                >
                                ...
                                <button
                                    ...
                                    tabindex="-1"
                                    type="button"
                                    @click="destroy(servicosItensValore)"
                                >
                                    <span class="rounded-full text-white shadow-lg">
                ...
                <pagination class="mt-6" :links="servicosItensValores.links" />
            </div>
        </div>
    </app-layout>
</template>
...
export default {
    ...
    methods: {
        destroy(servicosItensValore) {
            if (confirm("Você tem certeza que deseja excluir este registro?")) {
                this.$inertia.delete(
                    this.route(
                        "servicos-itens-valores.destroy",
                        servicosItensValore.id
                    )
                );
            }
        ...
        search() {
            this.$inertia.replace(
                this.route("servicos-itens-valores.index", { term: this.term })
            );
        },
    },
};
