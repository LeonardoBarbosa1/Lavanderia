...
export default {
    ...
    props: ["servicosItensValore", "errors","servicos"],
    data() {
        return {
            form: {
                valor: this.$props.servicosItensValore.valor,
                id_servicos: this.$props.servicosItensValore.id_servicos,
                produto_utilizado:
                    this.$props.servicosItensValore.produto_utilizado,
            },
        };
    },
    methods: {
        submit() {
            this.$inertia.put(
                route(
                    "servicos-itens-valores.update",
                    this.$props.servicosItensValore.id
                ),
                this.form
            );
        },
