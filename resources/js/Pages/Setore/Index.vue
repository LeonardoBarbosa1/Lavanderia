    ...
    <app-layout>
        ...
        >
            <div class="container">
                    ...
                    <div class="px-0 my-3 rounded-xl flex flex-col">
                        <div class="w-full">
                            ...
                            <a
                                ...
                                :href="
                                    route('setores.export', { term: this.term })
                                "
                                download="file.xlsx"
                            >
                                Exportar
                        ...
                        >
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    as="button"
                                    type="button"
                                    :href="route('setores.show', setore.id)"
                                >
                                ...
                                <Link
                                    ...
                                    as="button"
                                    type="button"
                                    :href="route('setores.edit', setore.id)"
                                >
                                    <span class="rounded-full text-white shadow-lg">
                ...
                <pagination class="mt-6" :links="setores.links" />
            </div>
        </div>
    </app-layout>
</template>
    ...
    methods: {
        destroy(setore) {
            if (confirm("Você tem certeza que deseja excluir este registro?")) {
                this.$inertia.delete(this.route("setores.destroy", setore.id));
            }
        },
        search() {
            this.$inertia.replace(
                this.route("setores.index", { term: this.term })
            );
        },
    },
};
