...
export default {
    ...
    props: ["cliente", "errors","cidades","status"],
    data() {
        return {
            form: {
                id_cidades: this.$props.cliente.id_cidades,
                status: this.$props.cliente.status,
                nome: this.$props.cliente.nome,
                cpf_cnpj: this.$props.cliente.cpf_cnpj,
    ...
    methods: {
        submit() {
            this.$inertia.put(
                route("clientes.update", this.$props.cliente.id),
                this.form
            );
        },
    },
